    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.parameter}>
        <div className={styles.param}>
          ...
          <span className={styles.paramData}>{props.windSpeed[0]}km/h <WiCloudyGusts className={styles.icon}/></span>
        </div>
      ...
      <div className={styles.parameter}>
        <div className={styles.param}>
          ...
          <span className={styles.paramData}>{maxTemp}°C <WiThermometer className={styles.icon}/></span>
        </div>
      ...
      <div className={styles.parameter}>
        <div className={styles.param}>
          ...
          <span className={styles.paramData}>{city}  <ImLocation2 className={styles.icon}/></span>
        </div>
      ...
      <div className={styles.parameter}>
        <div className={styles.param}>
          ...
          <span className={styles.paramData}>45  <WiSunrise className={styles.icon}/></span>
        </div>
      </div>
      </div>
    </div>
